...
public interface VehicleSeatMapper {
    @Select("SELECT seats_id, seats, price_per_day, price_per_distance, price_per_hour " +
            "FROM vehicle_seat ")
    ...
    @Insert("INSERT INTO vehicle_seat (seats, price_per_day, price_per_distance, price_per_hour) " +
            "VALUES (#{s_req.seats}, #{s_req.pricePerDay}, #{s_req.pricePerDistance}, #{s_req.pricePerHour}) ")
